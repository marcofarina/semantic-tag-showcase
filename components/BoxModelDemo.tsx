  ...
  return (
    <div id="box-model-trigger" className="mt-8 w-full">
      <div className="flex items-center justify-between mb-3">
        <h4 className="font-bold text-neutral-600 dark:text-neutral-300 flex items-center gap-2 text-lg">
          <Box size={20} />
          Demo: CSS Box Model
        </h4>
        <button 
          onClick={() => setIsOpen(!isOpen)}
          className="text-xs bg-neutral-200 dark:bg-notion-card text-neutral-800 dark:text-white px-4 py-2 rounded-full flex items-center gap-2 hover:bg-neutral-300 dark:hover:bg-notion-hover border border-neutral-300 dark:border-notion-border transition font-medium"
        >
          {isOpen ? (
      ...
      <div 
        ...
        className={`
          ...
          ${isOpen ? 'h-auto bg-white dark:bg-[#191919] p-8 border border-neutral-200 dark:border-notion-border rounded-2xl shadow-lg dark:shadow-black/40' : 'h-32 bg-neutral-100 dark:bg-notion-card/50 border-2 border-dashed border-neutral-300 dark:border-neutral-700 hover:border-blue-400 hover:bg-neutral-50 dark:hover:bg-notion-hover rounded-xl flex items-center justify-center'}
        `}
      >
        {!isOpen ? (
           <div className="text-center">
             <span className="font-mono text-blue-500 dark:text-blue-400 font-bold text-xl block mb-2">&lt;div&gt;</span>
             <p className="text-base text-neutral-500 dark:text-neutral-400">Clicca per rivelare il Box Model</p>
           </div>
        ) : (
          <div className="w-full flex flex-col items-center gap-8">
            <p className="text-sm md:text-base text-neutral-600 dark:text-neutral-400 text-center max-w-lg mb-2">
            ...
            <div className="relative text-xs font-mono font-bold select-none w-full max-w-3xl aspect-square sm:aspect-video flex items-center justify-center py-4">
              ...
              <div className="w-full h-full bg-orange-100 dark:bg-orange-950/20 border-2 border-dashed border-orange-300 dark:border-orange-700/50 rounded-2xl relative flex items-center justify-center p-8 sm:p-14 shadow-sm transition-all hover:bg-orange-200 dark:hover:bg-orange-900/30 group/margin">
                ...
                <div className="w-full h-full bg-yellow-400 dark:bg-yellow-600/80 rounded-xl relative flex items-center justify-center p-4 sm:p-5 shadow-sm transition-all hover:bg-yellow-500 dark:hover:bg-yellow-600 group/border">
                  ...
                  {/* Padding Area */}
                  <div className="w-full h-full bg-emerald-100 dark:bg-emerald-950/40 rounded-lg relative flex items-center justify-center p-8 sm:p-14 shadow-inner transition-all hover:bg-emerald-200 dark:hover:bg-emerald-900/50 group/padding border border-emerald-300/30">
                    ...
                    {/* Content Area */}
                    <div className="w-full h-full bg-blue-200 dark:bg-blue-900/30 border border-blue-400/30 relative flex flex-col items-center justify-center text-center shadow-sm group/content transition-all hover:bg-blue-300 dark:hover:bg-blue-900/40 min-h-[60px] min-w-[120px] rounded">
                      ...
                      <div className="absolute -bottom-6 text-[10px] text-neutral-500 font-normal opacity-0 group-hover/content:opacity-100 transition-opacity whitespace-nowrap bg-white dark:bg-neutral-800 px-2 py-0.5 rounded shadow">
            ...
            <div className="flex gap-4 sm:gap-6 text-sm flex-wrap justify-center text-neutral-600 dark:text-neutral-400">
